                ...
                VStack {
                    if let fetchedImageURL = fetchedImageURL,
                       let url = URL(string: fetchedImageURL) {
                        ...
                        Button {
                            toggleFavorite(url: fetchedImageURL)
                        } label: {
                            Image(systemName: "star.fill")
                                .foregroundColor(isFavorite(fetchedImageURL) ? .yellow : .gray)
                                .font(.title)
            ...
            do {
                ...
                DispatchQueue.main.async {
                    if let photo = reqResponse.photos.first {
                        // results found
                        fetchedImageURL = photo.src.original
